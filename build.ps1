...
(Get-Content $nuspecpath).replace('<dependencies>', "<projectUrl>https://cloudmersive.com/security-threat-detection-api</projectUrl><dependencies>") | Set-Content $nuspecpath
...
(Get-Content ./client/README.md).replace(' automatically generated by the [Swagger Codegen](https://github.com/swagger-api/swagger-codegen) project', " for the [Cloudmersive Seucrity Threat Detection API](https://www.cloudmersive.com/security-threat-detection-api)") | Set-Content ./client/README.md
