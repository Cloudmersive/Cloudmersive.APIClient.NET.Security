...
namespace Cloudmersive.APIClient.NET.Security.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class IPThreatDetectionResponse :  IEquatable<IPThreatDetectionResponse>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="IPThreatDetectionResponse" /> class.
        /// </summary>
        ...
        public IPThreatDetectionResponse(bool? isThreat = default(bool?), string threatType = default(string))
        {
        ...
        {
            return this.Equals(input as IPThreatDetectionResponse);
        }

        /// <summary>
        /// Returns true if IPThreatDetectionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of IPThreatDetectionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(IPThreatDetectionResponse input)
        {
            if (input == null)
                return false;
