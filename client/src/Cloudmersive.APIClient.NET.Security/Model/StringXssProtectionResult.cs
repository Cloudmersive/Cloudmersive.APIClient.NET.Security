...
namespace Cloudmersive.APIClient.NET.Security.Model
{
    ...
    /// </summary>
    [DataContract]
    public partial class StringXssProtectionResult :  IEquatable<StringXssProtectionResult>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="StringXssProtectionResult" /> class.
        /// </summary>
        ...
        public StringXssProtectionResult(bool? successful = default(bool?), bool? containedXss = default(bool?), string originalInput = default(string), string normalizedResult = default(string))
        {
        ...
        {
            return this.Equals(input as StringXssProtectionResult);
        }

        /// <summary>
        /// Returns true if StringXssProtectionResult instances are equal
        /// </summary>
        /// <param name="input">Instance of StringXssProtectionResult to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(StringXssProtectionResult input)
        {
            if (input == null)
                return false;
