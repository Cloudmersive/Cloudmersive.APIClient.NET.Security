...
namespace Cloudmersive.APIClient.NET.Security.Api
{
    /// <summary>
    ...
    public interface IContentThreatDetectionApi : IApiAccessor
    {
        ...
        /// </remarks>
        /// <exception cref="Cloudmersive.APIClient.NET.Security.Client.ApiException">Thrown when fails to make API call</exception>
    ...
    {
        private Cloudmersive.APIClient.NET.Security.Client.ExceptionFactory _exceptionFactory = (name, response) => null;
        ...
        {
            this.Configuration = new Cloudmersive.APIClient.NET.Security.Client.Configuration { BasePath = basePath };

            ExceptionFactory = Cloudmersive.APIClient.NET.Security.Client.Configuration.DefaultExceptionFactory;
        }
        ...
        /// <returns></returns>
        public ContentThreatDetectionApi(Cloudmersive.APIClient.NET.Security.Client.Configuration configuration = null)
        {
            if (configuration == null) // use the default one in Configuration
                this.Configuration = Cloudmersive.APIClient.NET.Security.Client.Configuration.Default;
            else
        ...
        public Cloudmersive.APIClient.NET.Security.Client.Configuration Configuration {get; set;}

        /// <summary>
        /// Provides a factory method hook for the creation of exceptions.
        /// </summary>
        public Cloudmersive.APIClient.NET.Security.Client.ExceptionFactory ExceptionFactory
        {
            get
            {
